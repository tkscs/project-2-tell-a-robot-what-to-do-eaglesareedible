...
* [ 5 / 10 ] Implements indefinite execusing using at least one while loop OR at least one recursive function call
    * My goal here was actually that the user could keep inputting commands indefinitely, not that one command would go on forever. Sorry that was unclear!
